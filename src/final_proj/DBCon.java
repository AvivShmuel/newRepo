...
public class DBCon {
	...
	static void open(){
	 ...
	 static int login(String name, String pass) throws SQLException{
		 open();
		 String  str;
	 ...
	 static boolean register(String username,String fname,String lname, String pass) throws SQLException{
		 open();
		 String  str;
