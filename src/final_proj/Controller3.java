...
// Controller class of level number 3
public class Controller3{
	...
	public Controller3(Level3 level3){
		this.level3 = level3;
		...
		addZombie(new Zombie(4,-800,300));
		addZombie(new Zombie(5,-1200,500));
	}
 ...
 //checke if there was a zombie hit raises the score by 10 in addition to downloading from the life of the zombie 1 and if the zombie's life reaches 0 it deletes it
		...
		{		
			TempZombie = z.get(i);
				...
				if (level3.play.getX() < TempZombie.getX()+TempZombie.getWidth()-60 && level3.play.getX()+level3.play.getWidth() > TempZombie.getX() && level3.play.getY() < TempZombie.getY()+TempZombie.getHeight()-40 && level3.play.getY() + level3.play.getHeight() > TempZombie.getY())
				{
					level3.play.hit();
					level3.play.moveX(1200);
					level3.repaint();
				}
		}
		...
		for(int j=0 ; j <m.size(); j++ )
		{
				...
				if (level3.play.getX() < TempMokesh.getX()+TempMokesh.getWidth() && level3.play.getX()+level3.play.getWidth() > TempMokesh.getX() && level3.play.getY() < TempMokesh.getY()+TempMokesh.getHeight()-15 && level3.play.getY() + level3.play.getHeight() > TempMokesh.getY())
				{
					level3.play.hit();
					level3.play.moveX(1200);
					level3.repaint();
		...
		for(int j=0 ; j <lf.size(); j++ )
		{
				...
				if (level3.play.getX() < TempLife.getX()+TempLife.getWidth()-15 && level3.play.getX()+level3.play.getWidth() > TempLife.getX() && level3.play.getY() < TempLife.getY()+TempLife.getHeight()-15 && level3.play.getY() + level3.play.getHeight() > TempLife.getY() && flag_lev==0)
				{
					level3.play.setLife(1);
					flag_lev=1;
					removeLife(TempLife);
					level3.repaint();
				}
		...
		for(int j=0 ; j <money.size(); j++ )
		{
				...
				if (level3.play.getX() < TempMoney.getX()+TempMoney.getWidth()-15 && level3.play.getX()+level3.play.getWidth() > TempMoney.getX() && level3.play.getY() < TempMoney.getY()+TempMoney.getHeight()-15 && level3.play.getY() + level3.play.getHeight() > TempMoney.getY() && flag_money==0)
				{
					level3.play.setScore(15);
					flag_money=1;
		...
		for(int j=0 ; j <bomb.size(); j++ )
		{
			TempBomb = bomb.get(j);
				...
				if (level3.play.getX() < TempBomb.getX()+TempBomb.getWidth()-15 && level3.play.getX()+level3.play.getWidth() > TempBomb.getX() && level3.play.getY() < TempBomb.getY()+TempBomb.getHeight()-15 && level3.play.getY() + level3.play.getHeight() > TempBomb.getY() && flag_bomb==0)
				{
					System.out.println("check2");
					level3.play.setLife(-4);
					level3.repaint();
					flag_bomb=1;
					removeBomb(TempBomb);
